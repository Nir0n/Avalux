...
class CarTable: NSObject, Table {
    ...
    func tableAttributeName(_ dataObjectAttributeName: String) -> String {
        return Car.jsonKeyPathsByPropertyKey()[dataObjectAttributeName] as! String
    }
    ...
    func getItemWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBObjectModel?, _ error: NSError?) -> Void) {
        ...
        objectMapper.load(Car.self, hashKey: AWSIdentityManager.default().identityId!, rangeKey: nil) { (response: AWSDynamoDBObjectModel?, error: Error?) in
    ...
    func scanWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        objectMapper.scan(Car.self, expression: scanExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            DispatchQueue.main.async(execute: {
                completionHandler(response, error as NSError?)
            })
        }
    ...
    func scanWithFilterDescription() -> String {
        let scanFilterValue = "demo-license plate-500000"
        return "Find all items with license plate < \(scanFilterValue)."
    }
    ...
    func scanWithFilterWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        scanExpression.filterExpression = "#licensePlate < :licensePlate"
        scanExpression.expressionAttributeNames = ["#licensePlate": "license plate" ,]
        scanExpression.expressionAttributeValues = [":licensePlate": "demo-license plate-500000" ,]
    ...
    func insertSampleDataWithCompletionHandler(_ completionHandler: @escaping (_ errors: [NSError]?) -> Void) {
        ...
        let itemForGet: Car! = Car()
        
        itemForGet._userId = AWSIdentityManager.default().identityId!
        itemForGet._licensePlate = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("license plate")
        itemForGet._model = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("model")
        ...
        for _ in 1..<numberOfObjects {
            ...
            item._licensePlate = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("license plate")
            item._model = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("model")
    ...
    func removeSampleDataWithCompletionHandler(_ completionHandler: @escaping ([NSError]?) -> Void) {
        ...
        objectMapper.query(Car.self, expression: queryExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            if let error = error as? NSError {
                DispatchQueue.main.async(execute: {
    ...
    func updateItem(_ item: AWSDynamoDBObjectModel, completionHandler: @escaping (_ error: NSError?) -> Void) {
        ...
        let itemToUpdate: Car = item as! Car
        
        itemToUpdate._licensePlate = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("license plate")
        itemToUpdate._model = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("model")
