...
class EventsTable: NSObject, Table {
    ...
    func tableAttributeName(_ dataObjectAttributeName: String) -> String {
        return Events.jsonKeyPathsByPropertyKey()[dataObjectAttributeName] as! String
    }
    ...
    func getItemWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBObjectModel?, _ error: NSError?) -> Void) {
        ...
        objectMapper.load(Events.self, hashKey: AWSIdentityManager.default().identityId!, rangeKey: nil) { (response: AWSDynamoDBObjectModel?, error: Error?) in
    ...
    func scanWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        objectMapper.scan(Events.self, expression: scanExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            DispatchQueue.main.async(execute: {
                completionHandler(response, error as NSError?)
            })
        }
    ...
    func scanWithFilterDescription() -> String {
        let scanFilterValue = "demo-typeOfEvent-500000"
        return "Find all items with typeOfEvent < \(scanFilterValue)."
    }
    ...
    func scanWithFilterWithCompletionHandler(_ completionHandler: @escaping (_ response: AWSDynamoDBPaginatedOutput?, _ error: NSError?) -> Void) {
        ...
        scanExpression.filterExpression = "#typeOfEvent < :typeOfEvent"
        scanExpression.expressionAttributeNames = ["#typeOfEvent": "typeOfEvent" ,]
        scanExpression.expressionAttributeValues = [":typeOfEvent": "demo-typeOfEvent-500000" ,]
    ...
    func insertSampleDataWithCompletionHandler(_ completionHandler: @escaping (_ errors: [NSError]?) -> Void) {
        ...
        let itemForGet: Events! = Events()
        
        itemForGet._userId = AWSIdentityManager.default().identityId!
        itemForGet._dateOfEvent = NoSQLSampleDataGenerator.randomSampleNumberSet()
        itemForGet._placeOfEvent = NoSQLSampleDataGenerator.randomSampleMap()
        itemForGet._typeOfEvent = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("typeOfEvent")
        ...
        for _ in 1..<numberOfObjects {
            ...
            let item: Events = Events()
            item._userId = AWSIdentityManager.default().identityId!
            item._dateOfEvent = NoSQLSampleDataGenerator.randomSampleNumberSet()
            item._placeOfEvent = NoSQLSampleDataGenerator.randomSampleMap()
            item._typeOfEvent = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("typeOfEvent")
    ...
    func removeSampleDataWithCompletionHandler(_ completionHandler: @escaping ([NSError]?) -> Void) {
        ...
        objectMapper.query(Events.self, expression: queryExpression) { (response: AWSDynamoDBPaginatedOutput?, error: Error?) in
            if let error = error as? NSError {
                DispatchQueue.main.async(execute: {
    ...
    func updateItem(_ item: AWSDynamoDBObjectModel, completionHandler: @escaping (_ error: NSError?) -> Void) {
        ...
        let itemToUpdate: Events = item as! Events
        
        itemToUpdate._dateOfEvent = NoSQLSampleDataGenerator.randomSampleNumberSet()
        itemToUpdate._placeOfEvent = NoSQLSampleDataGenerator.randomSampleMap()
        itemToUpdate._typeOfEvent = NoSQLSampleDataGenerator.randomSampleStringWithAttributeName("typeOfEvent")
